...
/**
 * Photographie EN CONTINU de l'état de `sync_queue` (voir [com.naniger.arzikina.domain.repository.SyncEngine.observeQueueStatus]),
 ...
 * ([com.naniger.arzikina.presentation.settings.SettingsViewModel.syncNow]) qu'après un déclenchement
