 ...
 * [com.naniger.arzikina.domain.repository.AuthRepository] et [AuthResult]).
 *
 * Une hiérarchie scellée dédiée — plutôt que de réutiliser
 * [com.naniger.arzikina.util.AppResult.Error] (message texte libre) — est
...
sealed class AuthError {
     ...
     *  la présentation est censée déjà valider via [com.naniger.arzikina.util.AuthValidator]
