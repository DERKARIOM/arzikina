 ...
 * [com.naniger.arzikina.domain.model.Transaction] réelle (voir sa doc, Étape 6 "Convertir une dépense
...
interface FinancialPlanRepository {
     ...
     * planification (voir [com.naniger.arzikina.util.FinancialPlanProgress]) sans une requête par
     * planification. */
     ...
     * financière", section 12) : crée une [com.naniger.arzikina.domain.model.Transaction] de type
     * DÉPENSE et met à jour [FinancialPlanItem.transactionId]/[FinancialPlanItem.actualAmount]/
     * [FinancialPlanItem.status] (toujours [com.naniger.arzikina.domain.model.PlanItemStatus.DONE]
     ...
     * [com.naniger.arzikina.domain.model.PlanItemStatus.CANCELLED] (Étape 11) : une dépense annulée n'a
