 ...
 * futur backend REST...) : seule [com.naniger.arzikina.data.repository.AuthRepositoryImpl]
 * sait qu'il s'agit aujourd'hui d'une authentification 100% locale (Room +
 * hachage PBKDF2, voir [com.naniger.arzikina.util.PasswordHasher]). Remplacer
 ...
 * d'une session déjà active (implémenté, voir [com.naniger.arzikina.data.security.BiometricAuthenticatorImpl]).
 *
...
interface AuthRepository {
     ...
     * [com.naniger.arzikina.util.AuthValidator]) par sécurité même si la
     * présentation les a déjà vérifiées, et vérifie l'unicité du nom
     * d'utilisateur et de l'e-mail (voir [AuthError][com.naniger.arzikina.domain.model.AuthError.UsernameAlreadyExists]
     * / [EmailAlreadyExists][com.naniger.arzikina.domain.model.AuthError.EmailAlreadyExists]).
     */
     ...
     * [AuthError.CurrentPasswordIncorrect][com.naniger.arzikina.domain.model.AuthError.CurrentPasswordIncorrect]
