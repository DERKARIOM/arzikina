...
/**
 * Photo de profil de l'utilisateur COURANT (voir [com.naniger.arzikina.domain.repository.SessionManager],
 ...
 * KDoc de tête de [com.naniger.arzikina.data.local.entity.UserProfilePhotoEntity] pour le raisonnement
...
interface ProfilePhotoRepository {
     ...
     * [com.naniger.arzikina.data.profile.ProfilePhotoFileStorage.contentUriFor]), ou `null` si
     ...
     * tête de [com.naniger.arzikina.data.local.entity.UserProfilePhotoEntity] : la ligne reste, avec
     ...
     * [com.naniger.arzikina.work.SyncWorker], jamais directement par la présentation (cahier des
     ...
     *   [com.naniger.arzikina.data.local.entity.UserProfilePhotoEntity.pendingUpload]), l'envoie
