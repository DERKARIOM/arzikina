 ...
 * [com.naniger.arzikina.domain.repository.UnifiedAuthRepository]) — point d'entrée UNIQUE désormais
 ...
 * [com.naniger.arzikina.data.repository.UnifiedAuthRepositoryImpl], jamais remontées telles quelles à la
 * présentation.
 */
sealed class UnifiedAuthError {
     ...
     * Jamais renvoyée par [com.naniger.arzikina.data.repository.UnifiedAuthRepositoryImpl.login]/la
    ...
    data class ValidationFailed(val reason: ValidationReason) : UnifiedAuthError() {
         ...
         *  (voir [com.naniger.arzikina.domain.repository.UnifiedAuthRepository.register]) — sans objet
         *  pour [com.naniger.arzikina.domain.repository.UnifiedAuthRepository.login], qui ne les valide
         *  jamais. */
     ...
     * [com.naniger.arzikina.data.repository.UnifiedAuthRepositoryImpl.attemptOfflineFallback]. Le
