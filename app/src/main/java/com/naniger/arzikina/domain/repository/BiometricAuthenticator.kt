 ...
 *
 * Points d'intégration (voir [com.naniger.arzikina.data.security.BiometricAuthenticatorImpl]) :
...
interface BiometricAuthenticator {
     ...
     * ferait, comme le reste des interfaces de ce module (voir [AuthResult][com.naniger.arzikina.domain.model.AuthResult]
