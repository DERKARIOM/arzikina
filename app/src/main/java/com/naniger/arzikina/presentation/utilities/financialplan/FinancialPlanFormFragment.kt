...
import com.naniger.arzikina.databinding.FragmentFinancialPlanFormBinding
 ...
 * que [com.naniger.arzikina.presentation.budget.BudgetFormFragment] pour la structure générale, et
 * même câblage des sélecteurs icône/couleur que
 * [com.naniger.arzikina.presentation.accounts.AccountFormFragment] (`IconPickerAdapter<T>` générique,
 * `ColorPickerAdapter`).
 */
@AndroidEntryPoint
