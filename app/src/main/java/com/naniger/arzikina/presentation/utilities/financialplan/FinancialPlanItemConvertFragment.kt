...
import com.naniger.arzikina.databinding.FragmentFinancialPlanItemConvertBinding
 ...
 * vient de passer à [com.naniger.arzikina.domain.model.PlanItemStatus.DONE]) au milieu de la pile.
 */
@AndroidEntryPoint
class FinancialPlanItemConvertFragment : Fragment(R.layout.fragment_financial_plan_item_convert) {
    ...
    private fun setUpInputs(binding: FragmentFinancialPlanItemConvertBinding) {
        MoneyInputFormatter.attach(binding.amountInput) { formatted -> viewModel.onActualAmountChange(formatted) }
