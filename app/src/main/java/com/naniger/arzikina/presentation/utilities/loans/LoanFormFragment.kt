...
import com.naniger.arzikina.databinding.FragmentLoanFormBinding
 ...
 * Prêts/Emprunts, qui observe déjà [com.naniger.arzikina.domain.repository.LoanRepository] et se met
...
class LoanFormFragment : Fragment(R.layout.fragment_loan_form) {
    ...
    private fun setUpInputs(binding: FragmentLoanFormBinding) {
        ...
        MoneyInputFormatter.attach(binding.firstPaymentAmountInput) { formatted ->
            viewModel.onFirstPaymentAmountChange(formatted)
        }
    }
