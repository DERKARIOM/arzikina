 ...
 * [com.naniger.arzikina.presentation.budget.BudgetUiItem]/
 * [com.naniger.arzikina.presentation.transactions.TransactionUiItem] : un modèle
 * de présentation dédié plutôt que de faire porter ce calcul dérivé par le
 * modèle domaine.
 */
/**
 * @param cardHolderName nom affiché sur une carte [com.naniger.arzikina.domain.model.AccountType.CREDIT_CARD]
