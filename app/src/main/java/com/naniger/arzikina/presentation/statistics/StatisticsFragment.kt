 ...
 * [com.naniger.arzikina.presentation.utilities.loans.LoanStatisticsFragment] pour un besoin différent).
 */
@AndroidEntryPoint
class StatisticsFragment : Fragment(R.layout.fragment_statistics) {
     ...
     *  `differenceValue` du Dashboard ([com.naniger.arzikina.presentation.dashboard.DashboardFragment]). */
