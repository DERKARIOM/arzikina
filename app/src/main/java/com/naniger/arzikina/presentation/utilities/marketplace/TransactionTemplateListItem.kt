...
/**
 * Modèle d'AFFICHAGE d'un [com.naniger.arzikina.domain.model.TransactionTemplate] pour la liste
 ...
 *
 * [currencyCode] : résolu depuis le compte associé ([com.naniger.arzikina.domain.model.Account]), pour
