 ...
 * fond "postcard" (voir [bg_postcard_bottom][com.naniger.arzikina.R.drawable.bg_postcard_bottom]),
...
class GroupedTransactionsAdapter(
     ...
     * [com.naniger.arzikina.presentation.dashboard.RecentTransactionsAdapter], qui
