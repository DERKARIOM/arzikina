 ...
 * liste. Valeurs au format ARGB (voir [com.naniger.arzikina.domain.model.Account.colorArgb]).
 *
 * NON MODIFIÉE par l'Étape 3 de "Planification" malgré la tentation d'y ajouter la couleur par
 * défaut d'une planification (0xFF42B998, voir [com.naniger.arzikina.domain.model.FinancialPlan.colorArgb]) :
 * [com.naniger.arzikina.presentation.utilities.loans.personAvatarColorArgb] dérive un INDEX dans cette
