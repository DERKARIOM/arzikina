...
import com.naniger.arzikina.databinding.FragmentReceiptsBinding
 ...
 * (voir [ReceiptsViewModel]). Même structure que [com.naniger.arzikina.presentation.utilities.LoansFragment]/
 * [com.naniger.arzikina.presentation.transactions.TransactionsFragment].
 *
...
class ReceiptsFragment : Fragment(R.layout.fragment_receipts) {
     ...
     * [com.naniger.arzikina.MainActivity]). */
