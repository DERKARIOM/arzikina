 ...
 * COMPTE") calculé à partir de [com.naniger.arzikina.domain.model.Account.colorArgb]
 * — pas de nouveau champ à stocker : la couleur choisie à la création du
 * compte (voir [com.naniger.arzikina.presentation.components.ColorPickerAdapter])
