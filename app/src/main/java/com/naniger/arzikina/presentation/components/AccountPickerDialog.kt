...
import com.naniger.arzikina.databinding.ItemAccountPickerBinding
 ...
 * doit pas dépendre de [com.naniger.arzikina.domain.repository.TransactionRepository]
 * pour le calculer lui-même — c'est à l'appelant (déjà en possession de ce
 * calcul, voir [com.naniger.arzikina.presentation.accounts.computeCurrentBalances])
 * de le fournir.
 */
