 ...
 * ([com.naniger.arzikina.presentation.accounts.AccountDetailFragment]), export/import de sauvegarde
 * ([com.naniger.arzikina.presentation.settings.BackupFragment])) : authentifie AVANT d'autoriser
 ...
 * logique de repli que [com.naniger.arzikina.MainActivity.resolveStartDestination]).
 *
