package com.naniger.arzikina.presentation.security
...
class BiometricLockViewModel @Inject constructor(
     ...
     * Connexion et utiliser son mot de passe — voir la doctrine de [com.naniger.arzikina.domain.repository.BiometricAuthenticator],
