 ...
 * (voir [com.naniger.arzikina.presentation.dashboard.RecentTransactionsAdapter],
 * qui n'affiche jamais ce champ) ou quand le compte est inconnu.
 * @param isTransferReceived pour [com.naniger.arzikina.domain.model.TransactionType.TRANSFER]
 ...
 * [com.naniger.arzikina.presentation.accounts.AccountDetailViewModel] et
