 ...
 *   (voir [MIGRATION_18_19]/[BudgetEntity]/[com.naniger.arzikina.domain.model.Budget]) ; index
 ...
 *   [com.naniger.arzikina.domain.model.RecurringTransaction]) — réellement utilisée pour programmer son
 ...
 *   [com.naniger.arzikina.domain.model.Receipt]) — indépendante du reste du modèle financier, aucune
 *   clé étrangère.
 * - 22 : Lien optionnel `receiptId` sur `transactions` (voir [MIGRATION_21_22]/[TransactionEntity]/
 *   [com.naniger.arzikina.domain.model.Transaction.receiptId]) — cahier des charges "Créer une
 ...
 *   [com.naniger.arzikina.domain.model.Account.displayOrder]) — cahier des charges "Réorganiser les
 ...
 *   [MIGRATION_28_29]/[TransactionTemplateEntity]/[com.naniger.arzikina.domain.model.TransactionTemplate])
