package com.naniger.arzikina.data.remote

import com.naniger.arzikina.data.remote.interceptor.SyncAuthInterceptor
 ...
 *  ([com.naniger.arzikina.data.remote.api.SyncApi]). Jamais utilisé par
 *  [com.naniger.arzikina.data.remote.api.SyncAuthApi] (`login.php`, pas encore de token à poser). */
@Qualifier
 ...
 * appels serveur.
 *
 * PAS de Retrofit (voir la KDoc de [com.naniger.arzikina.data.remote.api.SyncAuthApi] pour le
