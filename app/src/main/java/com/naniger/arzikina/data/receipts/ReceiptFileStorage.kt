package com.naniger.arzikina.data.receipts
 ...
 *
 * Ne connaît JAMAIS [com.naniger.arzikina.domain.model.Receipt] ni Room (voir [ReceiptRepositoryImpl],
 ...
 * la doc de [com.naniger.arzikina.domain.model.Receipt.localPath].
 */
@Singleton
class ReceiptFileStorage @Inject constructor(
     ...
     * [com.naniger.arzikina.domain.model.Receipt.fileName]).
     *
    ...
    /** Résout un [com.naniger.arzikina.domain.model.Receipt.localPath] (chemin relatif) vers le [File]
    ...
    /** @param relativePath voir [com.naniger.arzikina.domain.model.Receipt.localPath].
