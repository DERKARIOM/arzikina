...
import com.naniger.arzikina.data.backup.BACKUP_SCHEMA_VERSION
import com.naniger.arzikina.data.backup.BackupPayload
import com.naniger.arzikina.data.backup.remapIds
import com.naniger.arzikina.data.backup.securityQuestionOrDefault
import com.naniger.arzikina.data.backup.toDomain
 ...
 * ([com.naniger.arzikina.data.backup]), pour éviter un aller-retour Entity ->
 ...
 * respecte les clés étrangères (voir [TransactionEntity][com.naniger.arzikina.data.local.entity.TransactionEntity],
 * [BudgetEntity][com.naniger.arzikina.data.local.entity.BudgetEntity],
 * [LoanEntity][com.naniger.arzikina.data.local.entity.LoanEntity] et
 * [LoanPaymentEntity][com.naniger.arzikina.data.local.entity.LoanPaymentEntity] pour le
 ...
 * doc de [com.naniger.arzikina.domain.model.FinancialPlan]), traitée ici en parallèle, sans aucune
 ...
 * sauvegardé, et pas seulement ses métadonnées Room (voir [com.naniger.arzikina.data.backup.ReceiptDto]) :
 ...
 * `RecurringTransactionEntity`/`FinancialPlanEntity`), voir [com.naniger.arzikina.data.backup.TransactionTemplateDto].
 *
