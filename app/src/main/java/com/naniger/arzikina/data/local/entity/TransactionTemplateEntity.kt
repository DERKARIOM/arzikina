...
/**
 * Représentation Room d'un [com.naniger.arzikina.domain.model.TransactionTemplate] (cahier des charges
...
data class TransactionTemplateEntity(
     ...
     * [com.naniger.arzikina.domain.model.TransactionTemplate]) — `null` = pas d'heure par défaut,
