 ...
 * [com.naniger.arzikina.data.local.entity.RecurringTransactionEntity] (sans aucun sens d'un appareil à
 ...
 * [com.naniger.arzikina.data.local.entity.RecurringTransactionOccurrenceEntity.transactionId]).
 */
@Serializable
