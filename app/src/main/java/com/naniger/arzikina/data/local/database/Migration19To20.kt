 ...
 * autrement (voir [com.naniger.arzikina.domain.model.RecurringTransaction.DEFAULT_TRIGGER_HOUR]/
 * [com.naniger.arzikina.domain.model.RecurringTransaction.DEFAULT_TRIGGER_MINUTE], mêmes valeurs des deux
