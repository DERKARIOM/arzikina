package com.naniger.arzikina.data.backup

import kotlinx.serialization.Serializable

/**
 * Version du format de fichier de sauvegarde — indépendante de [com.naniger.arzikina.data.local.database.ArzikinaDatabase.version]
...
data class AccountDto(
    ...
    /**
     * Uniquement pour un compte [com.naniger.arzikina.domain.model.AccountType.CREDIT_CARD] :
 ...
 * avant la fonctionnalité "période fixe" — voir [BudgetEntity][com.naniger.arzikina.data.local.entity.BudgetEntity]/
 * [Budget][com.naniger.arzikina.domain.model.Budget]. Valeurs par défaut indispensables ici : sans elles,
...
data class RecurringTransactionDto(
    ...
    val createdAt: Long,
    val updatedAt: Long,
    /** Défaut 08:00 (voir `RecurringTransactionEntity`/[com.naniger.arzikina.domain.model.RecurringTransaction])
 ...
 * [com.naniger.arzikina.domain.model.TransactionTemplate], cahier des charges "Marketplace
