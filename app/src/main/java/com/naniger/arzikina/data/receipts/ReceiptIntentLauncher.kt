 ...
 * [com.naniger.arzikina.util.external.ExternalAppLauncher] : DÉLIBÉRÉMENT hors du domaine (types Android
...
class ReceiptIntentLauncher @Inject constructor(
     ...
     * entre-temps...) — même convention que [com.naniger.arzikina.util.external.ExternalAppLauncher.launch]. */
