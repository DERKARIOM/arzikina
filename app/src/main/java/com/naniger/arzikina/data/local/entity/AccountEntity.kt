 ...
 * manipule uniquement [com.naniger.arzikina.domain.model.Account] (voir
 ...
 * [com.naniger.arzikina.data.local.database.MIGRATION_6_7] : SQLite ne permet pas
...
data class AccountEntity(
    ...
    val createdAt: Long,
    /** Voir [com.naniger.arzikina.domain.model.Account.type] — ajouté en v11 (voir
     * `MIGRATION_10_11`), dérivé de [icon] pour les comptes déjà existants. */
    val type: AccountType = AccountType.CASH,
    /** Voir [com.naniger.arzikina.domain.model.Account.cardLastFourDigits]. */
    val cardLastFourDigits: String? = null,
    /** Voir [com.naniger.arzikina.domain.model.Account.cardExpiryMonth]. */
    val cardExpiryMonth: Int? = null,
    /** Voir [com.naniger.arzikina.domain.model.Account.cardExpiryYear]. */
    val cardExpiryYear: Int? = null,
    /** Voir [com.naniger.arzikina.domain.model.Account.isExcludedFromStatistics] — ajouté en v15 (voir
    ...
    /** Voir [com.naniger.arzikina.domain.model.Account.mobileMoneyPackageName] — ajouté en v17 (voir
    ...
    /** Voir [com.naniger.arzikina.domain.model.Account.displayOrder] — ajouté en v28 (voir
