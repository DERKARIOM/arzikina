 ...
 *
 * [categorySyncId] : PAS [com.naniger.arzikina.data.local.entity.BudgetEntity.categoryId] (un `id` Room
 ...
 * récurrent, voir la KDoc de [com.naniger.arzikina.domain.model.Budget]).
 */
@Serializable
