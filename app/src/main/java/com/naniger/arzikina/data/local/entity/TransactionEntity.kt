 ...
 * - `transferAccountId` (voir [com.naniger.arzikina.domain.model.Transaction.transferAccountId])
 ...
 *
 * `feeTransactionId` (voir [com.naniger.arzikina.domain.model.Transaction.feeTransactionId]) :
 ...
 *
 * `receiptId` (voir [com.naniger.arzikina.domain.model.Transaction.receiptId], [MIGRATION_21_22]) :
...
data class TransactionEntity(
    ...
    val accountId: Long,
    /** Voir [com.naniger.arzikina.domain.model.Transaction.transferAccountId] : `NULL` sauf pour un transfert. */
    val transferAccountId: Long?,
    /** Voir [com.naniger.arzikina.domain.model.Transaction.categoryId] : `NULL` uniquement pour un transfert. */
    val categoryId: Long?,
    val date: Long,
    ...
    /** Voir [com.naniger.arzikina.domain.model.Transaction.paymentMethod] : `NULL` = non précisé. */
    val paymentMethod: PaymentMethod?,
    val createdAt: Long,
    /** Voir [com.naniger.arzikina.domain.model.Transaction.feeTransactionId] et la doc de tête de
     * cette classe (pas de `ForeignKey`, cascade gérée par le repository). */
    val feeTransactionId: Long? = null,
    /** Voir [com.naniger.arzikina.domain.model.Transaction.feeType]. */
    val feeType: FeeType? = null,
    /** Voir [com.naniger.arzikina.domain.model.Transaction.receiptId] et la doc de tête de cette classe
