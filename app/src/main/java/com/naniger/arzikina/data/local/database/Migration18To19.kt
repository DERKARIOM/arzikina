 ...
 * mode récurrent existant (semaine/mois civil, voir [com.naniger.arzikina.domain.model.BudgetPeriod]) —
 ...
 *   [com.naniger.arzikina.domain.model.Budget]) ; renseignés uniquement pour les nouveaux budgets à
