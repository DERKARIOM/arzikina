...
interface CategoryDao {
    ...
    /** Réservé à [com.naniger.arzikina.data.repository.SyncEngineImpl] : volontairement SANS filtre
    ...
    /** Réservé à [com.naniger.arzikina.data.repository.SyncEngineImpl.enqueueUnsyncedLocalData] :
