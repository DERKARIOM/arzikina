 ...
 * fonction PURE (aucun accès disque ici) — c'est à l'appelant ([com.naniger.arzikina.data.repository.BackupRepositoryImpl.exportBackup],
 * seul à connaître [com.naniger.arzikina.data.receipts.ReceiptFileStorage]) de lire le fichier physique
