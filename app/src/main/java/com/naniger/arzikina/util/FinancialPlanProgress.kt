...
/**
 * Calculs centralisés d'une [com.naniger.arzikina.domain.model.FinancialPlan] à partir de ses
 * [FinancialPlanItem] (voir cahier des charges "Planification financière", sections 3/15) —
 * réutilisés par [com.naniger.arzikina.presentation.utilities.financialplan.FinancialPlansViewModel]
 ...
 * [com.naniger.arzikina.domain.model.FinancialPlan]) — recalculés à chaque émission du flux d'items.
 *
