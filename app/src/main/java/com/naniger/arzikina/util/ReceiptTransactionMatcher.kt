 ...
 * les catégories, déjà filtrés par [com.naniger.arzikina.domain.model.TransactionType] détecté via
...
object ReceiptTransactionMatcher {
     ...
     * ([sourceApp], voir [com.naniger.arzikina.domain.model.Receipt.sourceApp]) — seule correspondance
