...
object DatePeriods {
     ...
     * [com.naniger.arzikina.util.QuickDateRange]). */
     ...
     * local. Ajoutée pour [com.naniger.arzikina.util.StatsPeriodPreset]/`StatisticsViewModel` (période
     ...
     * afficher "Expire le ..." sur un budget, voir [com.naniger.arzikina.presentation.budget.BudgetAdapter]) :
     ...
     * pour le curseur "Aujourd'hui" ([com.naniger.arzikina.util.BudgetPace]) qui a besoin des DEUX
