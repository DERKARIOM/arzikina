...
object Constants {
     ...
     * ([com.naniger.arzikina.MainActivity]), import manuel (sélecteur de fichiers, à venir).
     */
    const val RECEIPT_MIME_TYPE = "application/pdf"

    /**
     * Compte créé automatiquement par [com.naniger.arzikina.data.local.database.MIGRATION_6_7]
