 ...
 * [com.naniger.arzikina.presentation.accounts.computeCurrentBalances], qui n'est PAS
...
object PersonalStatistics {
     ...
     * ([com.naniger.arzikina.domain.model.TransactionType.TRANSFER]) entre un compte
