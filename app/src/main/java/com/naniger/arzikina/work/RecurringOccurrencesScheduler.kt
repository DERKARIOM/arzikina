 ...
 * [com.naniger.arzikina.ArzikinaApplication.onCreate], jamais depuis un Fragment/ViewModel (même
 * principe qu'[com.naniger.arzikina.util.SystemBars], un utilitaire sans état plutôt qu'un objet à
 * injecter).
 */
