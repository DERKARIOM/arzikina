 ...
 * [com.arzikina.ne.domain.repository.UnifiedAuthRepository]). Contrairement à [AuthResult]/
 ...
 * compte serveur) prêt pour [com.arzikina.ne.domain.repository.SessionManager.startSession].
 */
