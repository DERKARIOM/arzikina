 ...
 *
 * Volontairement distinct de [com.arzikina.ne.domain.model.TransactionType] : chaque écran
 * détermine son propre [TransactionAmountTone] à partir de ses propres règles (ex. un transfert
 * REÇU côté [com.arzikina.ne.presentation.transactions.TransactionUiItem.isTransferReceived] reste
 ...
 * [com.arzikina.ne.domain.model.RecurringTransaction.type] soit un revenu ou une dépense normal —
 * voir `RecurringOccurrenceItemBinder`). Un mappage 1-à-1 depuis une seule
 * [com.arzikina.ne.domain.model.Transaction] ne suffirait donc pas à couvrir tous les écrans.
 */
 ...
 *    (voir [com.arzikina.ne.domain.model.signedAmount], toujours utilisé tel quel par
