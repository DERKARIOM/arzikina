 ...
 *
 * Volontairement ABSENT de [com.arzikina.ne.domain.repository.SyncAuthRepository] : le token en
 * clair ne doit jamais remonter jusqu'au domaine ou à la présentation (voir la KDoc de
 * [com.arzikina.ne.domain.model.SyncSession]) — seul ce contrat, interne à la couche data, y
