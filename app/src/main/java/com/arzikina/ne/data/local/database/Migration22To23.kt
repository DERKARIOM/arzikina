 ...
 *
 * `card_secrets` (voir [com.arzikina.ne.data.local.entity.CardSecretEntity]) est volontairement
 ...
 *
 * `users` (voir [com.arzikina.ne.data.local.entity.UserEntity]) est ÉGALEMENT absente de cette
